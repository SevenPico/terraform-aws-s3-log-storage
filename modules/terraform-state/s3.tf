...
data "aws_elb_service_account" "tfstate_storage" {
...
module "tfstate_storage" {
  ...
  source_policy_documents           = concat([one(data.aws_iam_policy_document.tfstate_storage[*].json)], var.s3_source_policy_documents)
